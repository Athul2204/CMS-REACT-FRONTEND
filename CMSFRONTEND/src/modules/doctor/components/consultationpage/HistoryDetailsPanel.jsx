...
return ( <div className="bg-[#1e293b] border border-white/10 rounded-xl p-4 md:p-5 text-white h-full flex flex-col">
  ...
  <div className="flex-1 overflow-y-auto pr-1 space-y-4 text-sm md:text-base">
    ...
    {/* 🧪 LAB RESULTS */}
{activeTab === "lab" &&
(labResults.length === 0 ? ( <p className="text-gray-400">No lab history</p>
) : (
labResults.map((item) => ( <div
     key={item.result_id}
